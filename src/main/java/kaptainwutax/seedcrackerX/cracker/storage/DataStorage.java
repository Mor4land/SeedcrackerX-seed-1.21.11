...
public class DataStorage {
    ...
    public static double getBits(Feature<?, ?> feature, boolean decorators18) {
        ...
        if (feature instanceof BuriedTreasure12111) return Math.log(100) / Math.log(2);
    ...
    public double getBaseBits() {
        ...
        for (Entry<Feature.Data<?>> e : this.baseSeedData) {
            if (!(e.data.feature instanceof PillagerOutpost) && !(e.data.feature instanceof PillagerOutpost12111)) {
    ...
    public double getLiftingBits() {
        ...
        for (Entry<Feature.Data<?>> e : this.baseSeedData) {
            ...
            } else if (e.data.feature instanceof Shipwreck12111 shipwreck) {
                bits += Math.log(shipwreck.getOffset() * shipwreck.getOffset()) / Math.log(2);
            }
        }
        return bits;
